...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-2 text-left align-middle font-medium text-zinc-500 [&:has([rule=checkbox])]:pr-0 [&>[rule=checkbox]]:translate-y-[2px] dark:text-zinc-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2 align-middle [&:has([rule=checkbox])]:pr-0 [&>[rule=checkbox]]:translate-y-[2px]",
      className
    )}
    {...props}
  />
