...
export default async function ProductOrder({ ordersId }: any) {
  ...
  return (
    <>
      <div className="text-zinc-100 p-4 pt-0">
        <div className="block mb-4 p-4 bg-slate-950 rounded-2xl text-center">
          کالا ها
        </div>
        {orderedProduct.map((productOrder: any) => (
          <div
            key={productOrder.id}
            className="py-4 md:py-8 rounded-3xl text-zinc-100 mb-4 bg-slate-950"
          >
